...
/**
 * Synchronous function. This has to be synchronous because system is not
...
function getPublicKey(_pathToPubKey) {
  ...
  const zpath = !_pathToPubKey ? pathToPubKey : _pathToPubKey;
